...
/*  Version 4.0.0   All files are text files in byte quantity.  char takes input
...
{	ifstream in_stream;
	...
	//Copies path_to_file for out_stream since appending after first write.
	char path_to_file_analyzed_txt[10000];
	for(int a = 0; a < 10000; a++) {path_to_file_analyzed_txt[a] = path_to_file[a];}
	...
	char user_determined_save_to_file;
	cin >> user_determined_save_to_file;
	
	//Overwrites first time. Then only: out_stream.open(path_to_file_analyzed_txt, ios::app);
	cout           << "\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
	               << "Analyzing file: "; //Do not exceed 67 width EVER!!!
	if(user_determined_save_to_file == 'y')
	{	out_stream.open(path_to_file_analyzed_txt);
		out_stream << "\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
		           << "Analyzing file: "; //Do not exceed 67 width EVER!!!
	}
	...
	{	cout << path_to_file[path_to_file_location_of_actual_file_name_beginning];
		if(user_determined_save_to_file == 'y')
	...
	in_stream.open("m");
	cout                                                << "md5sum\n";
	if(user_determined_save_to_file == 'y') {out_stream << "md5sum\n";}
	char garbage_byte;
	for(int a = 0; a < 32; a++)
	{	in_stream.get(garbage_byte);
		cout                                                << char(garbage_byte);
		if(user_determined_save_to_file == 'y') {out_stream << char(garbage_byte);}
	}
	cout << "\n\n";
	if(user_determined_save_to_file == 'y') {out_stream << "\n\n";}
	in_stream.close();
	...
	in_stream.open("1");
	cout                                                << "sha1sum\n";
	if(user_determined_save_to_file == 'y') {out_stream << "sha1sum\n";}
	for(int a = 0; a < 40; a++)
	{	in_stream.get(garbage_byte);
		cout                                                << char(garbage_byte);
		if(user_determined_save_to_file == 'y') {out_stream << char(garbage_byte);}
	...
	in_stream.open("2");
	cout                                                << "sha256sum\n";
	if(user_determined_save_to_file == 'y') {out_stream << "sha256sum\n";}
	for(int a = 0; a < 64; a++)
	{	in_stream.get(garbage_byte);
		cout                                                << char(garbage_byte);
		if(user_determined_save_to_file == 'y') {out_stream << char(garbage_byte);}
	...
	in_stream.open("5");
	cout                                                << "sha512sum\n";
	if(user_determined_save_to_file == 'y') {out_stream << "sha512sum\n";}
	for(int a = 0; a < 64; a++)
	{	in_stream.get(garbage_byte);
		cout                                                << char(garbage_byte);
		if(user_determined_save_to_file == 'y') {out_stream << char(garbage_byte);}
	...
	{	     if(a <  10) {cout << "occurrence of   " << a << ": ";}
		...
		else {distinct_bytes++;   cout << distribution[a];} //..........IMPORTANT: distinct_bytes++; is not copied to save-to-file if().
		...
		if(a == 9)
		{	for(int a = 0; a < length_of_tally; a++) 
			{	cout << " ";
				if(user_determined_save_to_file == 'y') {out_stream << " ";}
			}
			
			cout << "tab";
			if(user_determined_save_to_file == 'y') {out_stream << "tab";}
		}
		...
		{	for(int a = 0; a < length_of_tally; a++)
			...
			cout << "new line for Linux";
			if(user_determined_save_to_file == 'y') {out_stream << "new line for Linux";}
		}
		...
		{	for(int a = 0; a < length_of_tally; a++)
			...
			cout << "new line for Mac";
			if(user_determined_save_to_file == 'y') {out_stream << "new line for Mac";}
		}
		...
		{	for(int a = 0; a < length_of_tally; a++)
			...
			cout << "space";
			if(user_determined_save_to_file == 'y') {out_stream << "space";}
		}
		...
		{	for(int a = 0; a < length_of_tally; a++)
			...
			cout << char(a);
			if(user_determined_save_to_file == 'y') {out_stream << char(a);}
		}
	...
	if(user_determined_save_to_file == 'y') {out_stream << total_bytes << " Bytes total, " << distinct_bytes << " distinct\n";}
	...
	{	cout           << "\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\n"
		...
		{	if(a == user_byte_quantity) {break;}
			...
			{	temp_file_byte_normal = temp_file_byte;
				...
				cout                                                << "Byte# " << (a + 1) << " = ";
				if(user_determined_save_to_file == 'y') {out_stream << "Byte# " << (a + 1) << " = ";}
				
				if(temp_file_byte_normal < 100)
				{	cout << " ";
					if(user_determined_save_to_file == 'y') {out_stream << " ";}
				}
				
				if(temp_file_byte_normal <  10) 
				{	cout << " ";
					if(user_determined_save_to_file == 'y') {out_stream << " ";}
				}
				
				cout << temp_file_byte_normal;
				if(user_determined_save_to_file == 'y') {out_stream << temp_file_byte_normal;;}
				...
				else if    ( temp_file_byte_normal ==  13)  {cout       << " new line for Mac\n"  ;}
				...
				if(user_determined_save_to_file == 'y')
				{	if     ( temp_file_byte_normal ==   9)  {out_stream << " tab\n"               ;}
					else if( temp_file_byte_normal ==  10)  {out_stream << " new line for Linux\n";}
					else if( temp_file_byte_normal ==  13)  {out_stream << " new line for Mac\n"  ;}
					else if( temp_file_byte_normal ==  32)  {out_stream << " space\n"             ;}
					else if((temp_file_byte_normal  >  32)
